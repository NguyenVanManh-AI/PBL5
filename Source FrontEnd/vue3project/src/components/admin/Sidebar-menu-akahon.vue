<template>
  <div class="sidebar" :class="isOpened ? 'open' : ''" :style="cssVars">
    <div class="logo-details" style="margin: 10px 14px 0 14px;padding: 10px 0px;">
      ...
      <div class="logo_name" @click="compadmin">Admin PBL5 </div>
      <i style="color: #F84B2F;" class="bx" :class="isOpened ? 'bx-menu-alt-right' : 'bx-menu'" id="btn" @click="openN"/>
    </div>
    <div style="display: flex ; flex-direction:column; justify-content: space-between; flex-grow: 1; max-height: calc(100% - 60px); ">
      <div id="my-scroll" style="margin: 6px 14px 0 14px;">
        <ul class="nav-list" style="overflow: visible;">
          ...
          <span>
            <li @click="dashboard">
              <a :class="{adefault:true,aclick:colors[2]}"><i class="fa-solid fa-calendar-check"></i><span class="links_name">Admin Statistical</span></a>
              <span class="tooltip">Admin Statistical</span>
            </li>
          </span>
          ...
          <span>
            <li @click="mana_user">
              <a :class="{adefault:true,aclick:colors[8]}"><i class="fa-solid fa-user-large"></i><span class="links_name">Management User</span></a>
              <span class="tooltip">Management User</span>
            </li>
          </span>
          ...
          <span>
            <li @click="mana_admin">
              <a :class="{adefault:true,aclick:colors[9]}"><i class="fa-solid fa-user-shield"></i><span class="links_name">Management Admin</span></a>
              <span class="tooltip">Management Admin</span>
            </li>
          </span>
      ...
      <div v-if="isLoggedIn" class="profile" >
        ...
        <div class="profile-details">
          ...
          <div class="name_job"> 
            ...
            <div class="name" v-if="inf.fullname == null">Admin Full Name</div>
            <div class="job" style="margin-bottom: 10px;">Admin</div>
          </div>
        </div>
  ...
  export default {
    ...
    methods:{
      ...
      dashboard:function(){
        for(var i=0;i<this.colors.length;i++) this.colors[i] = false;
        this.colors[2]=true;
        this.$router.push({name:'AdminStatistical'});
      },
      mana_user:function(){
        for(var i=0;i<this.colors.length;i++) this.colors[i] = false;
        this.colors[8]=true;
        this.$router.push({name:'AdminManagementUser'});
      },
      mana_admin:function(){
        for(var i=0;i<this.colors.length;i++) this.colors[i] = false;
        this.colors[9]=true;
        this.$router.push({name:'AdminManagementAdmin'});
      },
      article:function(){
        for(var i=0;i<this.colors.length;i++) this.colors[i] = false;
        this.colors[3]=true;
