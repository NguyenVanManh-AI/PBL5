  ...
  <div id="filepicker">
    <div class="container upload-card">
      ...
      <form enctype="multipart/form-data" novalidate v-if="isInitial || isSaving">
        <h1 style="color:#F84B2F;font-size:14px"><i class="fa-solid fa-wand-magic-sparkles"></i> Update Images </h1>
        <div class="dropbox">
          <!-- bỏ multiple trong input đi để chỉ chọn được 1 ảnh thôi -->
          <input multiple type="file" name="photos" :disabled="isSaving" 
      ...
      <div v-if="isSuccess">
        ...
        <button type="button" class="btn-cancel btn btn-outline-danger mr-4" v-on:click="reset()"><i class="fa-solid fa-xmark"></i> Cancel</button>
        <button type="button" class="btn btn-outline-success" v-on:click="saveReal()"><i class="fa-solid fa-paper-plane"></i> Submit</button>
